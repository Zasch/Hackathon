			...
			<table>
				<thead>
					<tr>
						...
						<g:sortableColumn property="dateCreated" title="${message(code: 'ingredient.dateCreated.label', default: 'Date Created')}" />
					
						<g:sortableColumn property="lastUpdated" title="${message(code: 'ingredient.lastUpdated.label', default: 'Last Updated')}" />
					
						<th><g:message code="ingredient.nutritionInfo.label" default="Nutrition Info" /></th>
				...
				<g:each in="${ingredientInstanceList}" status="i" var="ingredientInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:formatDate date="${ingredientInstance.dateCreated}" /></td>
					
						<td><g:formatDate date="${ingredientInstance.lastUpdated}" /></td>
					
						<td>${fieldValue(bean: ingredientInstance, field: "nutritionInfo")}</td>
